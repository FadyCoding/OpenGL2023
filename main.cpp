...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "TPsOpenGL", NULL, NULL);
	...
	//Instance of a uniform variable from the vertex shader
	//Gets the ID of uniform variable
	GLuint uniID = glGetUniformLocation(shaderProgram.ID, "uTime");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Applies the uniform variable and applies it to the object
		glUniform1f(uniID, 300.0f*turn);
